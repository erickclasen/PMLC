...
print("Simple Neural Network: XOR function. ")
...
print(syn0[0],syn0[1],syn0[2])
test = syn0[0] * 1 + syn0[1] * 1 + syn0[2] * 1
#test = nonlin(test)
# Sigmoid non-linearity
test = 1/(1+np.exp(-test))

print(test)
print("Why is XOR going to 0.5? Poor performer of all gates. It needs another layer to work!")
